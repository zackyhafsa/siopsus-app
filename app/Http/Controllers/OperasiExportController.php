...
use App\Exports\OperisisExport; // <-- perhatikan nama! kalau filemu OperasisExport, import itu
...
class OperasiExportController extends Controller
{
    ...
    public function excel(Request $request)
    {
        ...
        $export = new OperasisExport($from, $to, $status, $jenis);
